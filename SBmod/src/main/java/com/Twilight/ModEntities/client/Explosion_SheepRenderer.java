...
public class Explosion_SheepRenderer extends MobRenderer<Explosion_Sheep_Red, Explosion_SheepModel<Explosion_Sheep_Red>> {
    ...
    @Override
    public ResourceLocation getTextureLocation(Explosion_Sheep_Red p_114482_) {
