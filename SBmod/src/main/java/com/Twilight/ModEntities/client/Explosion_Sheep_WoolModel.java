...
public class Explosion_Sheep_WoolModel extends EntityModel<Explosion_Sheep_Red> {
	...
	@Override
	public void setupAnim(Explosion_Sheep_Red p_102618_, float p_102619_, float p_102620_, float p_102621_, float p_102622_, float p_102623_) {
