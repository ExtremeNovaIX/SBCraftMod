...
public class Explosion_Sheep_WoolLayer extends RenderLayer<Explosion_Sheep_Red, Explosion_SheepModel<Explosion_Sheep_Red>> {
    ...
    public Explosion_Sheep_WoolLayer(RenderLayerParent<Explosion_Sheep_Red, Explosion_SheepModel<Explosion_Sheep_Red>> renderer, EntityModelSet modelSet) {
        super(renderer);
        this.woolModel = new Explosion_Sheep_WoolModel(modelSet.bakeLayer(ModModelLayers.EXPLOSION_SHEEP_WOOL_LAYER));
    }

    @Override
    public void render(PoseStack matrixStack, MultiBufferSource buffer, int packedLight, Explosion_Sheep_Red sheep,
